    ...
    lb.prototype = {
        c: function () {
            ...
            while (G--) {
                ...
                if (n) e.push(n);
                else e.push(j); if (j[g][w](" video") != -1) {
                    this.A(j);
                    this.b(j)
                }
            }
            ...
            else b.e = U(e[b.a], "img")[0]; if (e[b.a][k] == "A" || e[b.a][g] == "video") e[b.a][c][H] = "block";
            ...
            while (a--) {
                ...
                else d[a][g] = ""; if (e[a][k] == "A" || e[a][g] == "video") e[a][c][H] = a == b.a ? "block" : "none"
            }
        }, k: function () {
            var a = b.e[h]("alt") || "";
            if (a && a.substr(0, 1) == "#") {
            ...
            if (a[k] != "IMG") {
                if (a[k] == "A") var d = a[h]("href"),
                    ...
                    } else a[l].replaceChild(b, a); if (i) e[j] = b
                }
            }
        }, p: function (f) {
            if (e[b.a][k] == "IMG") b.e = e[b.a];
